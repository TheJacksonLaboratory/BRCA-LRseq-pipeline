...
# PSI_file <- "suppa/SE_PSI.psi"
# PSI_file_gtex <- "suppa_gtex/SE_PSI_gtex.psi"
# events_file <- "suppa/suppa_events/AS_events_SE_variable_10.ioe"
# analysis_name <- "BRCA_TCGA_GTEX"
# clust_dir <- "suppa_gtex/ts3_clust_output/" # Output folder (Rd file with df.exp for each cluster will be saved there)
# output_file <- "./suppa_gtex/clust_BRCA_TCGA.RData"

# # ********* Cluster variables
gff_file <- "/projects/dveiga/analysis/git/BRCA_isoforms/suppa/PacBio_NIC_NNC_ISM_Gencode30_merged.gtf"
PSI_file <- "/projects/dveiga/analysis/git/BRCA_isoforms/suppa/SE_PSI.psi"
PSI_file_gtex <- "/projects/dveiga/analysis/git/BRCA_isoforms/suppa_gtex/SE_PSI_gtex.psi"
events_file <- "/projects/dveiga/analysis/git/BRCA_isoforms/suppa/suppa_events/AS_events_SE_variable_10.ioe"
analysis_name <- "BRCA_TCGA_GTEX"
clust_dir <- "ts3_clust_output/" # Output folder (Rd file with df.exp for each cluster will be saved there)
output_file <- "/projects/dveiga/analysis/git/BRCA_isoforms/suppa_gtex/clust_BRCA_TCGA.RData"
