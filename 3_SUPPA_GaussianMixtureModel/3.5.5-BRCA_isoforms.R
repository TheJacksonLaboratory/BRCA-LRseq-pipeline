...
PSI_file <- "/projects/dveiga/analysis/git/BRCA_isoforms/suppa/AL_PSI.psi"
PSI_file_gtex <- "/projects/dveiga/analysis/git/BRCA_isoforms/suppa_gtex/AL_PSI_gtex.psi"
events_file <- "/projects/dveiga/analysis/git/BRCA_isoforms/suppa/suppa_events/AS_events_AL_variable_10.ioe"
analysis_name <- "BRCA_TCGA_GTEX"
clust_dir <- "AL_ts3_clust_output/" # Output folder (Rd file with df.exp for each cluster will be saved there)
output_file <- "/projects/dveiga/analysis/git/BRCA_isoforms/suppa_gtex/AL_clust_BRCA_TCGA.RData"
...
AL_clust <- clust
#Save results
save(AL_clust, file = output_file)
