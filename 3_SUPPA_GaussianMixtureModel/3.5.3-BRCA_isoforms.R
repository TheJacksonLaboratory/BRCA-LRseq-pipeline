...
PSI_file <- "/projects/dveiga/analysis/git/BRCA_isoforms/suppa/A3_PSI.psi"
PSI_file_gtex <- "/projects/dveiga/analysis/git/BRCA_isoforms/suppa_gtex/A3_PSI_gtex.psi"
events_file <- "/projects/dveiga/analysis/git/BRCA_isoforms/suppa/suppa_events/AS_events_A3_variable_10.ioe"
analysis_name <- "BRCA_TCGA_GTEX"
clust_dir <- "A3_ts3_clust_output/" # Output folder (Rd file with df.exp for each cluster will be saved there)
output_file <- "/projects/dveiga/analysis/git/BRCA_isoforms/suppa_gtex/A3_clust_BRCA_TCGA.RData"
...
A3_clust <- clust
#Save results
save(A3_clust, file = output_file)
