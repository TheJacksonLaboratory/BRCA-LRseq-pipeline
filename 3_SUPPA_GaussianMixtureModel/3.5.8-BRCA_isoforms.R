...
PSI_file <- "/projects/dveiga/analysis/git/BRCA_isoforms/suppa_250bp/AF_PSI.psi"
PSI_file_gtex <- "/projects/dveiga/analysis/git/BRCA_isoforms/suppa_250bp/AF_PSI_gtex.psi"
events_file <- "/projects/dveiga/analysis/git/BRCA_isoforms/suppa_250bp/suppa_events/AS_events_AF_variable_250.ioe"
analysis_name <- "BRCA_TCGA_GTEX"
clust_dir <- "AF_250bp_ts3_clust_output/" # Output folder (Rd file with df.exp for each cluster will be saved there)
output_file <- "/projects/dveiga/analysis/git/BRCA_isoforms/suppa_250bp/AF_250bp_clust_BRCA_TCGA.RData"
...
AF_250bp_clust <- clust
#Save results
save(AF_250bp_clust, file = output_file)
