...
PSI_file <- "/projects/dveiga/analysis/git/BRCA_isoforms/suppa/A5_PSI.psi"
PSI_file_gtex <- "/projects/dveiga/analysis/git/BRCA_isoforms/suppa_gtex/A5_PSI_gtex.psi"
events_file <- "/projects/dveiga/analysis/git/BRCA_isoforms/suppa/suppa_events/AS_events_A5_variable_10.ioe"
...
output_file <- "/projects/dveiga/analysis/git/BRCA_isoforms/suppa_gtex/A5_clust_BRCA_TCGA.RData"
...
A5_clust <- clust
#Save results
save(A5_clust, file = output_file)
